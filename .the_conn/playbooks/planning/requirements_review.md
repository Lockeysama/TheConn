...
**更新规则**：
- 进入某个 Phase/Step → 状态更新为 🔄
- 完成某个 Phase/Step → 状态更新为 ✅，填写输出
...
| ---- | ---------------------- | ---- | ---- | ------ |
| 1    | epic_init              | ⏳    | -    | 待开始 |
| 2    | context/add (Global)   | ⏳    | -    | 待开始 |
| 3    | context/add (Epic)     | ⏳    | -    | 待开始 |
| 4    | requirements_breakdown | ⏳    | -    | 待开始 |
...
**更新规则**：
- 进入某个 Step → 状态更新为 🔄
- 完成某个 Step → 状态更新为 ✅，填写输出，更新"预计剩余步骤"
- Step 失败 → 状态更新为 ❌，暂停衔接，询问用户处理方式
...
📊 衔接执行结果：
- ✅ Step 1: Epic 基础设施已初始化
- ✅ Step 2: 全局 Context 已处理
- ✅ Step 3: Epic Context 已添加
- ✅ Step 4: 规划已生成
