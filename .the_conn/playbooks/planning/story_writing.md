...
| Story 特征 | 单元测试 | BDD 测试 | E2E 测试 | 示例 |
|-----------|---------|---------|---------|------|
| 用户功能 Story | ✅ 必需 | ✅ 推荐 | ❌ 否 | 用户登录 |
| 技术/重构 Story | ✅ 必需 | ❌ 否 | ❌ 否 | 添加数据库索引 |
| Bug 修复 Story | ✅ 必需 | ⚠️ 回归测试 | ❌ 否 | 修复登录超时 |
| Feature E2E Story | ⚠️ 可选 | ✅ 必需 | ✅ 是 | E2E_Auth_Flow |
| Epic E2E Story | ❌ 否 | ✅ 必需 | ✅ 是 | Epic_User_Journey |
